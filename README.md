...
```hcl
module "s3_bucket" {
  source      = "git::https://github.com/SyncArcs/terraform-aws-s3.git?ref=v1.0.0"
...
## Examples
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/SyncArcs/terraform-aws-s3/tree/master/examples) directory within this repository.
...
## License
This project is licensed under the **MIT** License - see the [LICENSE](https://github.com/SyncArcs/terraform-aws-s3/blob/master/LICENSE) file for details.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_labels"></a> [labels](#module\_labels) | git::https://github.com/SyncArcs/terraform-aws-labels.git | 1.0.1 |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/SyncArcs/terraform-aws-s3"` | no |
